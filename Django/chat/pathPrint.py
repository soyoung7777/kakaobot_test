...
def subway_detail(swPath):
	...
	sdText += swPath['lane'][0]['name']+" 지하철을 탑승하세요!<br>⬇⬇⬇<br>"

	sdText += str(swPath['stationCount'])+"개 정류장 이동 후 "
	sdText += "<font color='#FF4D45'style='font-weight: bold;line-height:1.3em;'>"+swPath['endName']+"</font>역에서 하차하세요!<br>"
...
def bus_detail(busPath):
	...
	bdText += "<font color='#FF4D45'style='font-weight: bold;line-height:1.3em;'>"+busPath['endName']+"</font> 정류장에서 하차하세요<br>"
